...
output "guardduty_member_accts" {
  ...
  value = {for x in aws_organizations_organization.org.accounts: x.email => x.id if x.name != "${var.guardduty_master}"}
}

output "log_acct" {
  description = "Enterprise Logging Account ID"
  value = "${aws_organizations_account.member["smap-log"].id}"
}

output "sharedservices_acct" {
  description = "Enterprise Shared Services Account ID"
  value = "${aws_organizations_account.member["smap-sharedservices"].id}"
}

output "security_acct" {
  description = "Enterprise Security Account ID"
  value = "${aws_organizations_account.member["smap-security"].id}"
}
